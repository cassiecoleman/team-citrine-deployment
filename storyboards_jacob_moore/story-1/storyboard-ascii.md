# Storyboard: Schedule School Pickup (ASCII Wireframes)
...
│───────────────────────│
│                       │
│ Mon  7:30AM Home→Schl │
│ ───────────────────── │
│ Tue  7:30AM Home→Schl │
│ ───────────────────── │
│ Wed  7:30AM Home→Schl │
│ ───────────────────── │
│ Thu  7:30AM Home→Schl │
│ ───────────────────── │
│ Fri  7:30AM Home→Schl │
│ ───────────────────── │
│                       │
│ 🔔 You'll be notified │
│ 15 min before each    │
